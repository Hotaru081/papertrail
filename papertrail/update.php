    ...
    <body>
        ...
        <form method="POST" action="update_process.php?pno=<?php echo $pno; ?>" enctype="multipart/form-data">
            ...
            <select class="inp1" name="papertype" style="width: 100%">
                ...
                <option value="VOUCHER" <?php if ($row['papertype'] == 'VOUCHER') echo 'selected'; ?>>VOUCHER</option>
                ...
                <option value="PAYROLL" <?php if ($row['papertype'] == 'PAYROLL') echo 'selected'; ?>>PAYROLL</option>
                ...
                <option value="HR Files" <?php if ($row['papertype'] == 'HR Files') echo 'selected'; ?>>HR Files</option>
