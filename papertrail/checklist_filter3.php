...
if (!isset($_SESSION['username'])) {
    header("Location: checklist.php"); // Redirect to the login page or another appropriate page
    exit();
}
        ...
        if (isset($_POST['item'])) {
            foreach ($_POST['item'] as $id => $data) {
                ...
                $updateItemQuery = "UPDATE details 
                                ...
                                check17 = $check17, check17 = $check17, check17 = $check17, check17 = $check17,
                                check17 = $check17,
