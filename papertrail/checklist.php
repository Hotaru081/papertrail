...
?>
        ...
        if (isset($_POST['item'])) {
            foreach ($_POST['item'] as $id => $data) {
                ...
                $updateItemQuery = "UPDATE details 
                                SET timestamp1 = '$timestamp1', timestamp2 = '$timestamp2', timestamp3 = '$timestamp3',
                                timestamp4 = '$timestamp4', timestamp5 = '$timestamp5', timestamp6 = '$timestamp6',
                                timestamp7 = '$timestamp7', timestamp8 = '$timestamp8', timestamp9 = '$timestamp9',
                                timestamp10 = '$timestamp10', timestamp11 = '$timestamp11', timestamp12 = '$timestamp12',
                                timestamp13 = '$timestamp13', timestamp14 = '$timestamp14', timestamp15 = '$timestamp15',
                                timestamp16 = '$timestamp16', timestamp17 = '$timestamp17', timestamp18 = '$timestamp18'
                                , timestamp19 = '$timestamp19', timestamp20 = '$timestamp20', timestamp21 = '$timestamp21'
                                , timestamp22 = '$timestamp22', check1 = $check1, check2 = $check2, check3 = $check3, 
    ...
    echo "<h3>Particular: $particulars</h3>";
        ...
        while ($row = $itemResult->fetch_assoc()) {
            ...
            echo "<td><input type='text' name='item[$id][comment1]' value='$comment1'></td>";
            echo "<td><input type='checkbox' name='item[$id][check1]' class='task-checkbox' $check1></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment2]' value='$comment2'></td>";
            echo "<td><input type='checkbox' name='item[$id][check2]' class='task-checkbox'  $check2></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment3]' value='$comment3'></td>";
            echo "<td><input type='checkbox' name='item[$id][check3]' class='task-checkbox' $check3></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment4]' value='$comment4'></td>";
            echo "<td><input type='checkbox' name='item[$id][check4]' class='task-checkbox' $check4></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment5]' value='$comment5'></td>";
            echo "<td><input type='checkbox' name='item[$id][check5]' class='task-checkbox' $check5></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment6]' value='$comment6'></td>";
            echo "<td><input type='checkbox' name='item[$id][check6]' class='task-checkbox' $check6></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment7]' value='$comment7'></td>";
            echo "<td><input type='checkbox' name='item[$id][check7]' class='task-checkbox' $check7></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment8]' value='$comment8'></td>";
            echo "<td><input type='checkbox' name='item[$id][check8]' class='task-checkbox' $check8></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment9]' value='$comment9'></td>";
            echo "<td><input type='checkbox' name='item[$id][check9]' class='task-checkbox' $check9></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment10]' value='$comment10'></td>";
            echo "<td><input type='checkbox' name='item[$id][check10]' class='task-checkbox' $check10></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment11]' value='$comment11'></td>";
            echo "<td><input type='checkbox' name='item[$id][check11]' class='task-checkbox' $check11></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment12]' value='$comment12'></td>";
            echo "<td><input type='checkbox' name='item[$id][check12]' class='task-checkbox' $check12></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment13]' value='$comment13'></td>";
            echo "<td><input type='checkbox' name='item[$id][check13]' class='task-checkbox' $check13></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment14]' value='$comment14'></td>";
            echo "<td><input type='checkbox' name='item[$id][check14]' class='task-checkbox' $check14></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment15]' value='$comment15'></td>";
            echo "<td><input type='checkbox' name='item[$id][check15]' class='task-checkbox' $check15></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment16]' value='$comment16'></td>";
            echo "<td><input type='checkbox' name='item[$id][check16]' class='task-checkbox' $check16></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment17]' value='$comment17'></td>";
            echo "<td><input type='checkbox' name='item[$id][check17]' class='task-checkbox' $check17></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment18]' value='$comment18'></td>";
            echo "<td><input type='checkbox' name='item[$id][check18]' class='task-checkbox' $check18></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment19]' value='$comment19'></td>";
            echo "<td><input type='checkbox' name='item[$id][check19]' class='task-checkbox' $check19></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment20]' value='$comment20'></td>";
            echo "<td><input type='checkbox' name='item[$id][check20]' class='task-checkbox' $check20></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment21]' value='$comment21'></td>";
            echo "<td><input type='checkbox' name='item[$id][check21]' class='task-checkbox' $check21></td>";
            ...
            echo "<td><input type='text' name='item[$id][comment22]' value='$comment22'></td>";
            echo "<td><input type='checkbox' name='item[$id][check22]' class='task-checkbox' $check22></td>";
        ...
        echo "</table>";
        echo "<br>";
        echo "<input type='submit' class='sub' value='Save'>";
        echo "</form>";
    } else {
    ...
    <a href="admin.php"><button>Back</button></a> <!-- Back button to go to admin.php -->
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        checkbox.addEventListener('change', function () {
            const timestampInput = timestampInputs[index];
            if (checkbox.checked) {
            const now = new Date();
